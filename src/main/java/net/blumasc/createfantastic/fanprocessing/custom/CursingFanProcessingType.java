...
public class CursingFanProcessingType implements FanProcessingType {
    @Override
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(ModRecipes.CURSING.getType(), input, level)
                .isPresent();
    }
    ...
    public void morphAirFlow(AirFlowParticleAccess particleAccess, RandomSource random) {
        particleAccess.setColor(Color.mixColors(0x6c3baa, 0xf0768b, random.nextFloat()));
