...
public class EnchantingFanProcessingType implements FanProcessingType {
    @Override
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(ModRecipes.ENCHANTING.getType(), input, level)
                .isPresent();
    }
    ...
    public void morphAirFlow(AirFlowParticleAccess particleAccess, RandomSource random) {
        particleAccess.setColor(Color.mixColors(0x6c3baa, 0xffea99, random.nextFloat()));
