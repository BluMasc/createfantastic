...
public class SculkingFanProcessingType implements FanProcessingType {
    @Override
    ...
    public boolean canProcess(ItemStack stack, Level level) {
        ...
        return recipeManager
                .getRecipeFor(ModRecipes.SCULKING.getType(), input, level)
                .isPresent();
    }
    ...
    public void morphAirFlow(AirFlowParticleAccess particleAccess, RandomSource random) {
        particleAccess.setColor(Color.mixColors(0x04034b, 0x01011f, random.nextFloat()));
